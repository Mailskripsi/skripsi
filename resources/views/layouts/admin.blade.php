...
<head>
  ...
  <title>Aplikasi Pendataan Desa Natatoto</title>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <!-- <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Admin Desa Natatoto</a>
        </div>
      </div> -->
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/kelahiran" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Data Kelahiran
              </p>
          ...
          <li class="nav-item">
            <a href="/perpindahan" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                Data Perpindahan
              </p>
          ...
          <i class="nav-icon fas fa-th"></i>
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
              ...
              <li><a class="dropdown-item" href="#">Data Perpindahan</a></li>
...
<!-- 
  ...
  <footer class="main-footer">
    <strong>Aplikasi Kependudukan</strong>
    DESA NATATOTO.
